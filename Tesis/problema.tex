...
Nuestro problema consiste en un robot, situado en un entorno parcialmente conocido. Tenemos un objetivo, pero no 
...
\item
Si es posible sintetizar el LTS x para cualquier implementación de M, obtenemos el controlador que necesitamos, el cual es la
solución a nuestro problema.

\item
Si no es posible sintetizar el LTS x para ninguna implementación de M, sabemos que nuestro problema no tiene solución.

\item
Si es posible sintetizar el LTS x para algunas implementaciones de M, pero no se puede sintetizar para otras implementaciones de M,
